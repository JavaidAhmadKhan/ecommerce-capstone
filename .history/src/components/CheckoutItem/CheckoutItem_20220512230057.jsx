...
import { ReactComponent as Increase } from "../../assets/trash-solid.svg";
import { ReactComponent as Decrease } from "../../assets/trash-solid.svg";
...
const CheckoutItem = ({ cartItem }) => {
  ...
  return (
    <div className="checkout-item-container">
      ...
      >
        <Delete width="20" height="20" style={{ color: "red" }} />
      </div>
    </div>
  );
};
